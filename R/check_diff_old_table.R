...
# results
res_path <- ("/Users/rmylonas/tmp/datamining_pumba/results/well_behaved/delete_me.txt")
...
old_res_path <- "/Users/rmylonas/tmp/datamining_pumba/results/well_behaved/pumba_human_proteins_210608.txt"
