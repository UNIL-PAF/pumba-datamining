...
# load results
res <- path <- ("/Users/admin/tmp/datamining_pumba/results/homodimers_1569571862.15343.RData")
load(res <- path)
...
peak_selection <- "highest_peak_masses" # "closest_peak_masses
```
...
The observed masses correspond to the *HIGHEST* peak.
